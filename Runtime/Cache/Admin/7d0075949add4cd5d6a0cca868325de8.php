	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
                ...
                单位：<select name="price_target">
                    <option value="0" <?php if(($info["price_target"]) == "0"): ?>selected<?php endif; ?>>元/月</option>
                    <option value="1" <?php if(($info["price_target"]) == "1"): ?>selected<?php endif; ?>>万元</option>
                </select>
			</div>
		</div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-small" name="username" value="<?php echo ((isset($info["username"]) && ($info["username"] !== ""))?($info["username"]):''); ?>">
            </div>
        </div>
		<div class="form-item">
